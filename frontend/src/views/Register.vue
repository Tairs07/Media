      ...
      <el-card class="register-card">
        <template #header>
          <div class="card-header">
            <GradientText :text="'注册账号'" :colors="['#00ff88', '#ffd700']" />
          </div>
        </template>
        ...
        <el-form :model="form" @submit.prevent="handleRegister">
          ...
          <FadeContent :duration="800" :delay="500">
            <el-form-item>
              <el-button type="primary" style="width: 100%" class="tech-submit" @click="handleRegister">
                注册
              </el-button>
            </el-form-item>
          </FadeContent>
          ...
          <FadeContent :duration="800" :delay="600">
            <el-form-item>
              <el-button style="width: 100%" class="tech-secondary" @click="$router.push('/login')">
                已有账号？立即登录
              </el-button>
            </el-form-item>
          </FadeContent>
